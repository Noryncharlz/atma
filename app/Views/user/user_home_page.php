...
<head>
  ...
  <script src="https://kit.fontawesome.com/a48c0a032a.js" crossorigin="anonymous"></script>
...
<body>
  <!--The welcome note-->
<h1><?php if(session()->getFlashdata('msg')):?>
...
<!--///////////End of welcome note///////-->
 ...
 <div class="header">
        <div class="nav-menu">
            ...
            <div class="menu">
                <ul>
                    <li><a href="<?php echo base_url('logout'); ?>" class="active">LOG OUT</a></li>
                </ul>
            </div>
        </div>
        <div class="banner"> 
